...
function App() {
  ...
  const fetchPets = async () => {
    const res = await fetch("https://60888925a6f4a300174269a4.mockapi.io/pets");
  ...
  const addPet = async (pet) => {
    ...
    const res = await fetch(
      "https://60888925a6f4a300174269a4.mockapi.io/pets",
      {
        method: "POST",
        headers: {
  ...
  const removePet = async (id) => {
    ...
    const res = await fetch(
      `https://60888925a6f4a300174269a4.mockapi.io/pets/${id}`,
      {
        method: "DELETE",
      }
    );
